...
import com.sruthi.impl.Title;

public class DisplayForCouseId {
	...
	public static void main(String[] args)  {
        ...
        try {
			...
			for (Title title : list) {
				LOGGER.debug("Title-id : "+title.getTitleId()+"\nPublisher-id : "+title.getPubId()+"\nAuthor-id : "+title.getAuthorId()+"\ntitle: "+title.getTitle()+"\nprice: "+title.getPrice()+"\nversion: "+title.getVersionNumber());
